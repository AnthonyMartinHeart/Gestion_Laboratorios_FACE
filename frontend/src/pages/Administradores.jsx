...
const Administradores = () => {
  ...
  // Filtrar solo administradores y consultores
  const administradores = useMemo(() => (
    users.filter(u => {
      const rol = u.rol ? u.rol.toLowerCase().trim() : '';
      return rol === 'administrador' || rol === 'consultor' || rol === 'usuario';
    })
  ), [users]);
    ...
    <div className='users-container'>
      <div className='table-container'>
        <div className='top-table'>
          <h1 className='title-table'>Administradores del Sistema</h1>
        ...
        <Table
          ...
          selectableRows={true}
          selectedRows={dataUser.filter(u => administradores.some(a => a.rut === u.rut))}
        />
      </div>
